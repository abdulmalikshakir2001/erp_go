...
use App\Http\Controllers\EmployeeSelfAssController;
...
Route::post('payslip/bulkpay', [PaySlipController::class, 'bulkPay'])->name('payslip.bulkpay')->middleware(['auth', 'XSS']);
...
Route::post('payslip/bulk_delete', [PaySlipController::class, 'bulkDelete'])->name('payslip.bulk_delete')->middleware(['auth', 'XSS']);
...
Route::resource('employee-self-assessment', EmployeeSelfAssController::class)->middleware(['auth', 'XSS']);
Route::post('employee-self-assessment/ebs', [EmployeeSelfAssController::class, 'empByStar'])->name('empByStarSelf')->middleware(['auth', 'XSS']);
...
Route::any('import/productservice', [ProductServiceController::class, 'import'])->name('productservice.import');
...
Route::post('report/attendance/getdepartment', [AttendanceEmployeeController::class, 'getDepartment'])->name('report.attendance.getdepartment');
Route::post('report/attendance/getemployee', [AttendanceEmployeeController::class, 'getEmployee'])->name('report.attendance.getemployee');
