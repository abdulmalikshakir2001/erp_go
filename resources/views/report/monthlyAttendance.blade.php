...
@section('content')
    ...
    <div id="printableArea">
        <div class="row">
            <div class="col">
                <input type="hidden" value="{{  $data['branch'] .' '.__('Branch') .' '.$data['startDate'].' - '.$data['endDate'].' '.__('Attendance Report of').' '. $data['department'].' '.'Department'}}" id="filename">
            ...
            <div class="col">
                <div class="card p-4 mb-4">
                    ...
                    <h7 class="text-sm mb-0">{{$data['startDate']}} - {{$data['endDate']}}</h7>
                </div>
            </div>
        </div>
