@php
    ...
    $totalEarning = $payslip->basic_salary + $payslipDetail['totalEarning'];
    $netSalary = $totalEarning - $payslipDetail['totalDeduction'];
@endphp
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-4 text-end text-sm">
                                <div class="invoice-detail-item pb-2">
                                    ...
                                    <div class="invoice-detail-value">{{ \Auth::user()->priceFormat($totalEarning) }}</div>
                                </div>
                                ...
                                <div class="invoice-detail-item">
                                    ...
                                    <div class="invoice-detail-value invoice-detail-value-lg">{{ \Auth::user()->priceFormat($netSalary) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
