                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @if( Gate::check('manage indicator') || Gate::check('manage appraisal') || Gate::check('manage goal tracking'))
                                        ...
                                        @elseif(\Auth::user()->type == 'Employee')
                                            <a class="dash-link" href="#">{{ __('Employee Dashboard') }}<span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        @endif -->
                                        ...
                                        @elseif(\Auth::user()->type == 'Employee')
                                        <li class="dash-item {{ (request()->is('employee-self-assessment*') ? 'active' : '') }}">
                                            <a class="dash-link" href="{{ route('employee-self-assessment.index') }}">{{ __('Appraisal') }}</a>
                                        </li>
