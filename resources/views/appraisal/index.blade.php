                        ...
                        <table class="table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('Employee')}}</th>
                                    <th>{{ __('Staff Self Assessment') }}</th>
                                    <th>{{__('Supervisor Rating')}}</th>
                                        ...
                                        <td>
                                            @if(!empty($appraisal->self_assessment))
                                                ...
                                                @for($i = 1; $i <= 5; $i++)
                                                    ...
                                                    @endif
                                                @endfor
                                                <span class="theme-text-color">({{ number_format($selfRating, 1) }})</span>
                                            @else
                                                <span>{{ __('N/A') }}</span>
                                            @endif
                                        </td>
