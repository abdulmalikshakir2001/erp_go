...
@section('page-title')
    {{__('Manage Self Assessments')}}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Self Assessments')}}</li>
@endsection
@push('css-page')
    <style>
...
@section('action-btn')
    <div class="float-end">
    @can('create emp self ass')
       <a href="#" data-size="lg" data-url="{{ route('employee-self-assessment.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create New Self Assessment')}}" class="btn btn-sm btn-primary">
                                            ...
                                            <td>
                                                @can('show appraisal')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" data-url="{{ route('employee-self-assessment.show', $appraisal->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Self Assessment Detail')}}" data-bs-toggle="tooltip" title="{{__('View')}}" data-original-title="{{__('View Detail')}}" class="mx-3 btn btn-sm align-items-center">
                                                ...
                                                @can('edit appraisal')
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" data-url="{{ route('employee-self-assessment.edit', $appraisal->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Self Assessment')}}" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}" class="mx-3 btn btn-sm align-items-center">
                                                ...
                                                @can('delete appraisal')
                                                    <div class="action-btn bg-danger ms-2">
                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['employee-self-assessment.destroy', $appraisal->id],'id'=>'delete-form-'.$appraisal->id]) !!}
