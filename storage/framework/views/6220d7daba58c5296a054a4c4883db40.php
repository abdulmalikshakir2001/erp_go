                        ...
                        <table class="table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('Staff Self Assessment')); ?></th>
                                    <th><?php echo e(__('Supervisor Rating')); ?></th>
                                    <th><?php echo e(__('Self Assessment')); ?></th>
                            ...
                            <tbody class="font-style">
                                <?php $__currentLoopData = $appraisals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appraisal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(!empty($appraisal->self_assessment)): ?>
                                                <?php
                                                    $selfRating = array_sum($appraisal->self_assessment) / count($appraisal->self_assessment);
                                                ?>
                                                <?php for($i = 1; $i <= 5; $i++): ?>
                                                    <?php if($selfRating < $i): ?>
                                                        <?php if(is_float($selfRating) && (round($selfRating) == $i)): ?>
                                                            <i class="text-warning fas fa-star-half-alt"></i>
                                                        <?php else: ?>
                                                            <i class="fas fa-star"></i>
                                                        <?php endif; ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php endfor; ?>
                                                <span class="theme-text-color">(<?php echo e(number_format($selfRating, 1)); ?>)</span>
                                            <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp_go\main-file\resources\views/appraisal/index.blade.php ENDPATH**/ ?>