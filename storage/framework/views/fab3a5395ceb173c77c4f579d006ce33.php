                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <?php if( Gate::check('manage indicator') || Gate::check('manage appraisal') || Gate::check('manage goal tracking')): ?>
                                        ...
                                        <?php elseif(\Auth::user()->type == 'Employee'): ?>
                                            <a class="dash-link" href="#"><?php echo e(__('Employee Dashboard')); ?><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <?php endif; ?> -->
                                        ...
                                        <?php elseif(\Auth::user()->type == 'Employee'): ?>
                                        <li class="dash-item <?php echo e((request()->is('employee-self-assessment*') ? 'active' : '')); ?>">
                                            <a class="dash-link" href="<?php echo e(route('employee-self-assessment.index')); ?>"><?php echo e(__('Appraisal')); ?></a>
                                        </li>
...
<?php /**PATH C:\xampp\htdocs\erp_go\main-file\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>