...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Re-initialize Choices.js when the modal is shown
        $('#commonModal').on('shown.bs.modal', function () {
            initializeChoices();
        });

        function initializeChoices() {
            var multipleSelectElements = document.querySelectorAll('.multiple-select, .select');
            multipleSelectElements.forEach(function (element) {
                if (!element.classList.contains('choices-initialized')) {
                    new Choices(element, {
                        removeItemButton: true,
                        placeholder: true,
                        placeholderValue: element.querySelector('option[disabled]').innerText,
                        shouldSort: false,
                        itemSelectText: '',
                    });
...
<?php /**PATH C:\xampp\htdocs\erp_go\main-file\resources\views/layouts/admin.blade.php ENDPATH**/ ?>