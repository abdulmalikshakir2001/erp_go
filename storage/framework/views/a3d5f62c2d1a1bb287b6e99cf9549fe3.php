...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Self Assessments')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Self Assessments')); ?></li>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create emp self ass')): ?>
       <a href="#" data-size="lg" data-url="<?php echo e(route('employee-self-assessment.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create New Self Assessment')); ?>" class="btn btn-sm btn-primary">
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show appraisal')): ?>
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" data-url="<?php echo e(route('employee-self-assessment.show', $appraisal->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Self Assessment Detail')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('View')); ?>" data-original-title="<?php echo e(__('View Detail')); ?>" class="mx-3 btn btn-sm align-items-center">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit appraisal')): ?>
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" data-url="<?php echo e(route('employee-self-assessment.edit', $appraisal->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Edit Self Assessment')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>" class="mx-3 btn btn-sm align-items-center">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete appraisal')): ?>
                                                    <div class="action-btn bg-danger ms-2">
                                                        <?php echo Form::open(['method' => 'DELETE', 'route' => ['employee-self-assessment.destroy', $appraisal->id],'id'=>'delete-form-'.$appraisal->id]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp_go\main-file\resources\views/employee-self-assessment/index.blade.php ENDPATH**/ ?>